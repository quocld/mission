        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <div className="relative group">
              ...
              {openDropdown === 'companies' && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl py-2 z-50 text-gray-800 border border-gray-100">
                  ...
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">So funktioniert's</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">Ersparnis berechnen</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">Fallstudien</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">Preise</a>
            ...
            <div className="relative group">
              ...
              {openDropdown === 'talent' && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl py-2 z-50 text-gray-800 border border-gray-100">
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">Übersicht</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">Remote-Jobs</a>
                  <a href="#" className="block px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">Remote-Unternehmen</a>
                  <div className="relative group/submenu">
                    <a href="#" className="flex items-center justify-between px-4 py-2 text-sm hover:bg-gray-50 hover:text-blue-600">
                      Ressourcen
                      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
